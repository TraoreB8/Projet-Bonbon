            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                        <li>
                            <button class="dropdown-item active" type="button" style="color:#000;">
                                <a href="formAjout.php" style="color:#000;">Ajouter un produit</a>
                            </button>
                        </li>
                        <li>
                            <button class="dropdown-item active" type="button" style="color:#000;">
                                <a href="choixModif.php" style="color:#000;">Modifier un produit</a>
                            </button>
                        </li>
                        <li>
                            <button class="dropdown-item active" type="button" style="color:#000;">
                                <a href="choixSupp.php" style="color:#000;">Supprimer un produit</a>
                            </button>
                        </li>
                    </ul>
                </div>
...
?>
    <div class='card'>
        ...
        <div class='card-body'>
            ...
            <a class="btn btn-primary" href="modif1.php?id=<?php echo $produit->id?>">Modifier</a>
        </div>
    </div>
<?php
